...
def run(): 
	...
	if platform.system() == "Linux":
		home = expanduser("~")
		os.chdir( home + '/Dropbox/Aspuru-Guzik/python_lab/jamespy/j3/')
	elif platform.system() == "Darwin":
		home = expanduser("~")
		os.chdir( home + '/Dropbox (Personal)/Aspuru-Guzik/python_lab/jamespy/j3/')
	...
	if platform.system() == "Linux":
		os.system('mv jpyx.*.so ../../jamespyx_linux/jx3/.')
	elif platform.system() == "Darwin":
		os.system('mv jpyx.*.so ../../jamespyx_mac/jx3/.')
