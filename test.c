...
static CYTHON_INLINE int __pyx_f_4test_int_max(int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_4test_int_min(int, int); /*proto*/
...
static char __pyx_k_home_jamessungjinkim_Dropbox_As[] = "/home/jamessungjinkim/Dropbox/Aspuru-Guzik/python_lab/jamespy/test.pyx";
...
static CYTHON_INLINE int __pyx_f_4test_int_max(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
...
static CYTHON_INLINE int __pyx_f_4test_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
...
static PyMethodDef __pyx_mdef_4test_1naive_convolve = {"naive_convolve", (PyCFunction)__pyx_pw_4test_1naive_convolve, METH_VARARGS|METH_KEYWORDS, 0};
...
static PyObject *__pyx_pf_4test_naive_convolve(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_f, PyArrayObject *__pyx_v_g) {
  ...
  __pyx_t_4test_DTYPE_t __pyx_t_16;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
 ...
 */
      __pyx_v_s_from = __pyx_f_4test_int_max((__pyx_v_smid - __pyx_v_x), (-__pyx_v_smid));
 ...
 */
      __pyx_v_s_to = __pyx_f_4test_int_min(((__pyx_v_xmax - __pyx_v_x) - __pyx_v_smid), (__pyx_v_smid + 1));
 ...
 *             value = 0
 */
      __pyx_v_t_from = __pyx_f_4test_int_max((__pyx_v_tmid - __pyx_v_y), (-__pyx_v_tmid));
 ...
 */
      __pyx_v_t_to = __pyx_f_4test_int_min(((__pyx_v_ymax - __pyx_v_y) - __pyx_v_tmid), (__pyx_v_tmid + 1));
 ...
 *         raise ValueError("Only odd dimensions on filter supported")
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4test_1naive_convolve, NULL, __pyx_n_s_test); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
